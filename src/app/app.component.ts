...
export class AppComponent {
  ...
  public graph = {
    data: [
      { x: this.testData.sizeMB, y: this.testData.timeSec, type: 'scatter', name: "Testing dataset", mode: 'markers', marker: { color: 'red' } },
      { x: this.trainData.sizeMB, y: this.trainData.timeSec, type: 'scatter', name: "Training dataset", mode: 'markers', marker: { color: 'blue' } }

    ],
    layout: { width: 520, height: 540, title: 'Training dataset vs. test dataset' }
  };
